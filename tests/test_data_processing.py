import pandas as pd
import os
from src.data_processing import RFMTransformer, TemporalAggregator, CategoricalAggregator, build_and_run_pipeline

# Sample mini-dataset
SAMPLE = pd.DataFrame([
    {'CustomerId': 'C1', 'TransactionId': 'T1', 'TransactionStartTime': '2025-01-01', 'Value': 100, 'ProductCategory': 'A', 'ChannelId': 'X', 'PricingStrategy': 1},
    {'CustomerId': 'C1', 'TransactionId': 'T2', 'TransactionStartTime': '2025-01-05', 'Value': 200, 'ProductCategory': 'B', 'ChannelId': 'X', 'PricingStrategy': 1},
    {'CustomerId': 'C2', 'TransactionId': 'T3', 'TransactionStartTime': '2025-01-03', 'Value': 150, 'ProductCategory': 'A', 'ChannelId': 'Y', 'PricingStrategy': 2},
], )
...
def test_categorical_aggregator():
    cat = CategoricalAggregator(['ProductCategory','ChannelId','PricingStrategy']).transform(SAMPLE)
